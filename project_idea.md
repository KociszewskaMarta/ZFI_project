# Projekt ZFI: Aplikacja "_BezBarier_" - Koncepcja i Analiza Rynku

## 1. Pomysł na produkt (Aplikacja "_BezBarier_")
...
![alt text](gus-osoby-niepelnosprawne.png)
...
![alt text](gus-piramida-wiek-plec.png)
...
![alt text](gus-wypadki-pracy.png)
...
![Wariant A – Próg rentowności z grantem FERS](bep_wariant_a.png)
...
![Wariant B – Próg rentowności w modelu Bootstrap](bep_wariant_b.png)
...
# Projekt ZFI: Aplikacja "_BezBarier_" - Harmonogram i Wdrożenie
...
![alt text](harmonogram.png)

# Projekt ZFI: Aplikacja "_BezBarier_" - Strategia Marketingowa
